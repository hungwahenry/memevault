...
const session = (db, sessionOptions) => {
    const options = Object.assign({ sessionName: 'session', collectionName: 'sessions', sessionKeyFn: keys_1.getSessionKey }, sessionOptions);
    ...
    return (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (ctx[sessionName] != null) {
            yield saveSession(key, ctx[sessionName]);
        }
    });
};
